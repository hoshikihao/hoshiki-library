...
一年前我写下了在少数派的第一篇文章《[论什么是真正的自学](https://sspai.com/post/87551)》，讲了讲我关于学习的一些理解和方法，现在回看，有些观点我依然认同，另一些观点已经有了更深入的认知。
...
到了这个阶段，依然要再次确认，是否真的需要开展学习？因为任何问题的解决方法，可能都有更简单的那一种。就比如你需要一个 to-do list，市面上的软件调查了一圈，没有想要的，都太复杂了，不够简洁，嗯，可能需要学编程去自己做一个出来。

但我们换个角度，直接买本便利贴，把每天的任务写下来贴在屏幕旁边，这问题不就解决了吗？好吧，你就是想要一个「软件版」的 to-do list ，那现在 AI 生成一个简单的小工具也很容易，所以又要想想，如果 AI 交付的结果就符合你的预期，你还愿意花时间去学吗？你想要的是那个结果，还是做这件事的过程？
...
现在，我们的学习项目就是：通过学习「XX 编程语言」构建一个「to-do list」软件。
...
![](/articles/ai-jishu-zixue/01.jpg)
...
1. 我们想要一个 to-do list，这个 to-do list 应该长什么样子，由哪几个部分组成，有什么功能？
2. 大概从上到下可以分成三个部分：
...
3. 每个待办事项应该长什么样？可以分成左右两个部分：
    1. 左边是标题，显示要做的事情
    2. 右边有按钮：一个是「编辑」，可以编辑标题文字；一个是「完成」，点击后表示这个待办事项已经完成；还应该有一个「删除」，处理多余的待办
...
4. 整个软件运行的过程发生了哪些事？
    ...
    4. 待办事项应该实现的功能：点击「编辑」修改标题、点击「完成」切换完成状态、点击「删除」将待办从列表中移除
5. 软件运行中，哪些信息是「会改变的」？
    1. 标题会根据每天的日期变化
    2. 待办事项的数量
    3. 待办事项的标题、完成状态、以及是否「存在」，即添加和删除

看到了吗，就是这么一个简单到不能再简单的 to-do list，都有这么多要考虑的东西。
...
![](/articles/ai-jishu-zixue/02.jpg)
...
接下来，以 to-do list 这个案例，我们大概模拟一下这个实现过程。

首先输入一个基本的 prompt，对 AI 做一个总体的约束。

![](/articles/ai-jishu-zixue/03.jpg)

然后，告诉它我们要实现的最终结果是什么，以及第一步该干嘛。

![](/articles/ai-jishu-zixue/04.jpg)

对于多个选项，让 AI 按照我们的要求再次确认。

![](/articles/ai-jishu-zixue/05.jpg)

![](/articles/ai-jishu-zixue/06.jpg)

只要是你不懂的点，都应该去询问 AI。

![](/articles/ai-jishu-zixue/07.jpg)

![](/articles/ai-jishu-zixue/08.jpg)

![](/articles/ai-jishu-zixue/09.jpg)

这里出现问题，AI 只在代码中对每行进行了一些简单注释，并没有具体解释每行代码，所以我们需要告诉它进行更为细致的解释。

![](/articles/ai-jishu-zixue/10.jpg)

![](/articles/ai-jishu-zixue/11.jpg)

如果代码运行不符合预期，直接问 AI 应该如何修改，以及为什么。

![](/articles/ai-jishu-zixue/12.jpg)

如果 AI 一次性给出太多答案，你可以回退到上一步，把握对整体流程的控制。

![](/articles/ai-jishu-zixue/13.jpg)

你也可以根据自己的理解先写出代码，然后让 AI 检查你的代码并加以解释。

![](/articles/ai-jishu-zixue/14.jpg)
...
这个 to-do list 跑通之后，你也大概能明白写代码到底是怎么一回事了，真正的知识都是来源于现实交互中那些无法言说的微小细节，通过自己完成一个项目，边做边学，还有 AI 针对当前进度的实时反馈，我们就把各种概念和应用场景直接联系了起来，这样学到的才是真东西。
...
从上面的案例我们也能看到，用 AI 编程，或者干各种事，绕不开的就是语言沟通中必然会出现的那些问题。AI 的上限取决于人的上限，最终还是要看人拿它来干啥。

想更好地用 AI 辅助学习，相比各种精修细调的 prompt，我们更应该去了解各种教育模式，知道什么是好的学习方法，搞清自己适合的学习类型。了解了这些最根本的东西，你自然也明白怎么让 AI 去帮助自己。
...
在现在这个阶段，AI 的本质其实依然是执行人类决策的工具。只不过，随着 AI 的发展，人机协作的过程会更加流畅，我们对于其交付的结果会更加信任。假如真有一天，AI 不再需要人的指挥就能独立做事，那我们也不用讨论这些有的没的了，赶紧派人去找[约翰·康纳](https://zh.wikipedia.org/wiki/%E7%B4%84%E7%BF%B0%C2%B7%E5%BA%B7%E7%B4%8D)吧。

## 结语：如何成为「大佬」

![](/articles/ai-jishu-zixue/15.jpg)
